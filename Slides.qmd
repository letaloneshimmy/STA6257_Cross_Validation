...
::: {.column width="50%"}
![Number of nodes and layers in a neural network](neural_network.png){width="85%"}
:::

::: {.column width="50%"}
![Number of branches in a decision tree](decision_tree.png){width="65%"}
:::
::::
:::
...
<!-- Take the model you are going to use for prediction and fit it to the training data. 
Take the fitted model you developed in step 3 and apply it to the 1 test fold. 
After applying it to the model, you would take the resulting prediction and determine the accuracy by comparing what was predicted from the training folds to the actual values from the test fold. -->
